		...
		"""	
			...
			def forward(self,W,bias,X):
				...
				def grad(dy):
					...
					return dW,dB,dX
				return Z, grad """
		return AConnect(output_size,Wstd=Wstd,Bstd=Bstd,isBin=isBin,pool=pool,Slice=Slice,d_type=d_type,weights_regularizer=weights_regularizer,bias_regularizer=bias_regularizer)
