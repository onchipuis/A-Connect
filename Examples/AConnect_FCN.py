...
for k in range(3):
	...
	layers.FC_AConnect(128,Wstd=Wstd[k],Bstd=Bstd[k],isBin="no",pool=None,Slice=1,d_type=tf.dtypes.float32,weights_regularizer=None,bias_regularizer=None),
...
scripts.plotBox(x,[0,30,50,70],["AConnect 30%","AConnect 50%","AConnect 70%"],[red_line,blue_line,green_line],[red_fill,blue_fill,green_fill],'./test')
